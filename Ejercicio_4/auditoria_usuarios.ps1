...
$sinLogon | Out-File -FilePath "$env:C:\Users\5Uriel\Documents\LAP_RUBEN_RUHL_FCFM\usuarios_sin_logon.txt" 

$conLogon | Out-File -FilePath "$env:C:\Users\5Uriel\Documents\LAP_RUBEN_RUHL_FCFM\usuarios_con_logon.txt" 
